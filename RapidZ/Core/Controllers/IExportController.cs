...
namespace RapidZ.Core.Controllers
{
    ...
    public interface IExportController
    {
        ...
        /// <param name="customOutputPath">Optional custom output path for generated files</param>
        /// <returns>Task representing the async operation</returns>
        Task RunAsync(ExportInputs exportInputs, CancellationToken cancellationToken, string selectedView, string selectedStoredProcedure, string? customOutputPath = null);
    }
}